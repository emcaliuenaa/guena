...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE documentos_conc SET nombre = '$nuevoNombre', NumeroDeOficio = '$nuevoNumeroOficio', contenido = '$nuevoDocumento' WHERE id = '$idDocumento'";
    ...
    $sql = "SELECT * FROM documentos_conc WHERE id = '$idDocumento'";
