...
if (mysqli_num_rows($resultado) > 0) {
    ...
    <body>
        ...
        <button onclick="window.location.href = 'crear_internas.php';" class="btn btn-agregar">crear nuevo proyecto</button>
        <script>
        ...
        <table>
            ...
            while ($fila = mysqli_fetch_assoc($resultado)) {
                ...
                <tr>
                    ...
                    <td><?php echo $fila['FechaAprobacion']; ?></td>
                    <td>
                        <a href="editar_int.php?id=<?php echo $fila['id']; ?>" class="btn btn-editar">Editar</a>
                        <a href="eliminar_int.php?id=<?php echo $fila['id']; ?>" class="btn btn-eliminar">Eliminar</a>
                    </td>
                </tr>
                <?php
            }
...
<?php
    ...
    <head>
    <div class="button-container">
            <form action="descargar_copia.php" method="post">
                <input type="submit" name="descargar" value="Descargar Datos">
            </form>
        </div>
        <title>REDES INTERNAS</title>
    ...
    <div class="button-container">
        ...
        <button onclick="window.location.href = 'crear_internas.php';">crear nuevo proyecto</button>
        <script>
        $(document).ready(function() {
            $('#searchInput').on('keyup', function() {
                var value = $(this).val().toLowerCase();
