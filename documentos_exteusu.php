...
$sql = "SELECT * FROM documentos WHERE id LIKE '%$terminoBusqueda%' OR nombre LIKE '%$terminoBusqueda%' OR tipo LIKE '%$terminoBusqueda%'";
...
if (mysqli_num_rows($resultado) > 0) {
    ...
    <html>
    <head>
        <title>OFICIOS DE APROVACION REDES Externas</title>
    ...
    <h1>Oficios de Aprobacion Redes Externas</h1>
