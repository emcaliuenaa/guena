...
$sql = "SELECT * FROM documentos WHERE id LIKE '%$terminoBusqueda%' OR nombre LIKE '%$terminoBusqueda%' OR NumeroDeOficio LIKE '%$terminoBusqueda%'";
...
if (mysqli_num_rows($resultado) > 0) {
    ...
    <form method="GET" action="">
        ...
        <button onclick="window.location.href = 'subir.php';">Subir Documento</button>
    <script>
    ...
    <table>
        ...
        <tbody>
            ...
            // Conexión a la base de datos
            $conexion = mysqli_connect("20953994", "", "", "+*/////////////8rol");
            ...
            if (mysqli_num_rows($resultado) > 0) {
                while ($fila = mysqli_fetch_assoc($resultado)) {
                    ...
                    echo "<td><a href=\"visualizar_documento.php?id=" . $fila["id"] . "\" target=\"_blank\">Ver</a></td>";
                    ?>
                     <td>
                        <a href="editar_documentos_ex.php?id=<?php echo $fila['id']; ?>">Editar</a>
                        <a href="eliminar documentosEx.php?id=<?php echo $fila['id']; ?>">Eliminar</a>
                     </td>
                    <?php
                    echo "</tr>";
                }
